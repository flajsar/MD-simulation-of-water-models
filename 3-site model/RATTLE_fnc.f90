module verlet
    ...
    contains 
        ...
        subroutine verlet1(N,x,a,v,delec,dt,l,ni_bar)
            implicit none
            integer,intent(in):: N
            real(8),intent(in):: dt,l,delec(3*N,2),ni_bar
            real(8),intent(inout)::x(3*N,3),a(3*N,3),v(3*N,3)
            integer::i
        ...
        subroutine verlet2(N,x,a,v,delec,dt) 
                implicit none
                integer,intent(in):: N
                real(8),intent(in):: dt,delec(3*N,2)
                real(8),intent(inout)::x(3*N,3),a(3*N,3),v(3*N,3)
                integer::i
                do i=1,3*N 
        ...
        subroutine rattle_polozaji(N,x,a,v,delec,dt,l,dOH,dHH,virial)
            implicit none
            integer,intent(in):: N
            real(8),intent(in):: dt,l,dOH,dHH,delec(3*N,2),a(3*N,3)
            real(8),intent(inout)::x(3*N,3),v(3*N,3),virial
        ...
        subroutine rattle_hit(N,x,a,v,delec,dt,l,dOH,dHH,virial) 
            implicit none
            integer,intent(in):: N
            real(8),intent(in):: dt,l,dOH,dHH,delec(3*N,2)
            real(8),intent(inout)::x(3*N,3),a(3*N,3),v(3*N,3),virial
